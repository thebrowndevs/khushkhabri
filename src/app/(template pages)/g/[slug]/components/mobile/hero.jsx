    ...
    return (
        <section ref={containerRef} className="relative w-full font-serif h-[125vh] overflow-hidden">
            ...
            <motion.img
                ...
                className="absolute -left-25 bottom-[20%] w-[150px] h-auto drop-shadow-2xl z-20"
            ...
            <motion.img
                ...
                className="absolute -right-25 bottom-[20%] w-[150px] h-auto drop-shadow-2xl z-20"
                initial={{ opacity: 0, x: 100 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.8 }}
            />
